...
public class GhostbustersPrizedPossessionsMIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(GhostbustersPrizedPossessionsMIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/GhostbustersPrizedPossessionsMIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/GhostbustersPrizedPossessionsMIIW/InitOutcome.xml").getDocumentElement();
